...
export default function AboutMe() { 
    return (
        <motion.div           
            ...
            className="bg-[#FF910010] col-start-2 col-end-10 md:col-span-5 row-span-6 backdrop-blur-2xl rounded-sm border border-amber-500 p-2 text-wrap overflow-auto"
            >
