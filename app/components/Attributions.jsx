...
export default function Attributions() {
    ...
    return (
        <motion.div           
            ...
            className="bg-[#FF910010] text-sm col-start-2 col-end-12 sm:col-start-7 sm:col-end-12 md:col-span-3 lg:col-start-4 lg:col-end-6 row-span-1 md:row-span-2 backdrop-blur-2xl rounded-sm border border-amber-500 p-2 text-wrap overflow-auto"
            >
