  ...
  const [index, setIndex] = useState(0);
    ...
    return (
        <motion.div           
            ...
            className="bg-[#FF910010] text-sm col-start-2 col-end-12 sm:col-start-2 sm:col-end-7 md:col-span-3 lg:col-start-2 lg:col-end-4 row-span-1 md:row-span-2 backdrop-blur-2xl rounded-sm border border-amber-500 p-2 text-wrap overflow-auto"
            >
            ...
            <div className="flex flex-row justify-between font-[Roboto] align-middle text-sm mt-2">
                ...
                >
                  <img src={contactMethods[index].image} className="mx-auto h-8 w-8" alt="Contact image"/>
                </motion.a>
