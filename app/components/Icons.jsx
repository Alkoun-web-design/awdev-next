...
export function Spinner() {
	return (
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="block h-12 w-12 mx-auto my-auto animate-spin">
...
export function Signal(){
	return (
		<svg className="h-8 w-8 mx-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
			<path fill="currentColor" d="m194.6 7.5l5.8 23.3C177.7 36.3 156 45.3 136 57.3l-12.3-20.6c22-13.2 45.9-23.1 70.9-29.2m122.8 0l-5.8 23.3c22.7 5.6 44.3 14.5 64.3 26.6l12.4-20.6c-21.9-13.3-45.9-23.2-70.9-29.3M36.8 123.7c-13.3 22-23.2 45.9-29.3 70.9l23.3 5.8c5.6-22.7 14.5-44.3 26.6-64.3zM24 256c0-11.6.9-23.3 2.6-34.8l-23.7-3.6c-3.8 25.4-3.8 51.3 0 76.7l23.7-3.6C24.9 279.2 24 267.6 24 256m364.3 219.2L376 454.6c-20 12.1-41.6 21-64.2 26.6l5.8 23.3c24.9-6.2 48.7-16.1 70.7-29.3M488 256c0 11.6-.9 23.3-2.6 34.8l23.7 3.6c3.8-25.4 3.8-51.3 0-76.7l-23.7 3.6c1.7 11.4 2.6 23 2.6 34.7m16.5 61.4l-23.3-5.8c-5.6 22.7-14.5 44.3-26.6 64.3l20.6 12.4c13.3-22 23.2-45.9 29.3-70.9m-213.7 168c-23 3.5-46.5 3.5-69.5 0l-3.6 23.7c25.4 3.8 51.3 3.8 76.7 0zm152-91.8c-13.8 18.7-30.4 35.3-49.2 49.1l14.2 19.3c20.7-15.2 39-33.4 54.2-54.1zM393.6 69.2c18.8 13.8 35.3 30.4 49.2 49.2l19.3-14.4c-15.2-20.6-33.4-38.9-54.1-54.1zM69.3 118.4c13.8-18.8 30.4-35.3 49.2-49.2L104 49.9C83.4 65.1 65.2 83.4 49.9 104zm405.9 5.3L454.6 136c12.1 20 21 41.6 26.6 64.2l23.3-5.8c-6.1-24.9-16-48.7-29.3-70.7m-254-97.1c23-3.5 46.5-3.5 69.5 0l3.6-23.7c-25.4-3.8-51.3-3.8-76.7 0zM81.6 468.4L32 480l11.6-49.6l-23.4-5.5l-11.5 49.6c-3 12.9 5 25.8 17.9 28.8c3.6.8 7.3.8 10.9 0L87 492zm-56.4-64.9l23.4 5.4l8-34.4c-11.7-19.6-20.4-40.8-25.8-63l-23.3 5.8c5.2 21.2 13.1 41.7 23.6 60.8zm112 52l-34.4 8l5.4 23.4l25.3-5.9c19.2 10.4 39.6 18.4 60.8 23.6l5.8-23.3c-22.1-5.5-43.3-14.3-62.8-26zM256 48c-114.9.1-207.9 93.2-207.9 208.1c0 39.1 11.1 77.4 31.9 110.6L60 452l85.3-20c97.2 61.2 225.6 32.1 286.8-65.1S464.2 141.2 367 80c-33.2-20.9-71.7-32-111-32"></path>
		</svg>
	)
}
...
export function Github(){
	return (
		<svg className="h-8 w-8 mx-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
			<path fill="currentColor" d="M16.974 2.31c.696-.237 1.69-.62 2.279.032c.4.444.5 1.188.571 1.755c.08.634.099 1.462-.111 2.282C20.516 7.415 21 8.653 21 10c0 2.042-1.106 3.814-2.743 5.042a9.5 9.5 0 0 1-2.592 1.354c.215.491.335 1.033.335 1.604v3a1 1 0 0 1-1 1H9a1 1 0 0 1-1-1v-.995c-.955.117-1.756.017-2.438-.272c-.711-.302-1.208-.77-1.58-1.218a10 10 0 0 1-.481-.638c-.145-.206-.255-.367-.37-.516c-.234-.302-.363-.385-.447-.413a1 1 0 0 1 .632-1.897c.666.222 1.1.702 1.397 1.087c.15.195.298.409.423.586c.132.188.254.356.382.51c.253.302.506.522.826.657c.314.134.776.22 1.5.12L8 17.978a4 4 0 0 1 .334-1.582a9.5 9.5 0 0 1-2.59-1.354C4.105 13.815 3 12.043 3 10c0-1.346.483-2.583 1.284-3.62c-.21-.82-.192-1.647-.112-2.282c.074-.59.155-1.295.571-1.757c.59-.653 1.584-.268 2.28-.03c.619.21 1.384.544 2.125 1.044A11.4 11.4 0 0 1 12 3.001c.993 0 1.951.124 2.849.355a9 9 0 0 1 2.125-1.046"></path>
		</svg>
	)
}

export function ProtonMail(){
	return (
		<svg className="h-8 w-8 mx-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
			<path fill="currentColor" fillRule="evenodd" d="M403.1 126.3v337.4H459c29.2 0 52.9-24 52.9-53.6V60.2c0-10.1-11.6-15.6-19.3-9.2zm-78 65.7L223 283.3c-17.4 15.6-43.4 15.9-61.3.9L0 148.1V60.3c0-10.1 11.6-15.7 19.3-9.2l202.9 170.5c19.6 16.5 48.1 16.5 67.7 0z" opacity={0.5}></path>
			<path fill="currentColor" d="m403.1 126.4l-78 65.6h.1L223 283.3c-17.4 15.6-43.4 15.9-61.3.9L0 148.1v262c0 29.6 23.7 53.6 52.9 53.6h350.2z"></path>
		</svg>
	)
}
...
export function Menu(){
	return (
		<svg className="h-8 w-8 mx-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
			<path fill="currentColor" fillRule="evenodd" d="M19.75 12a.75.75 0 0 0-.75-.75H5a.75.75 0 0 0 0 1.5h14a.75.75 0 0 0 .75-.75m0-5a.75.75 0 0 0-.75-.75H5a.75.75 0 0 0 0 1.5h14a.75.75 0 0 0 .75-.75m0 10a.75.75 0 0 0-.75-.75H5a.75.75 0 0 0 0 1.5h14a.75.75 0 0 0 .75-.75" clipRule="evenodd"></path>
		</svg>
	)
}
...
export function LinkedIn(){
	return (
		<svg className="h-8 w-8 mx-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
